...
### Changed
- Release workflow uses `actions/checkout` again; publishing stays on `gh`.

## [1.0.4] - 2026-07-28

### Changed
- Release workflow uses only `git` + `gh` on the runner (no marketplace actions).
...
[1.0.5]: https://github.com/adriano-kaiser/feedwatch/compare/v1.0.4...v1.0.5
[1.0.4]: https://github.com/adriano-kaiser/feedwatch/compare/v1.0.3...v1.0.4
